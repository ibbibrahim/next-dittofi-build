...
function Container(props) {
	...
	<input className="form-control form-control-lg" placeholder="New password *" required="true" type=""
	>
	</input>
	...
	<input className="form-control form-control-lg" placeholder="Retype new password *" required="true" type=""
	>
	</input>
	...
	<button className="btn btn-primary text-uppercase btn-lg" type="submit"
	>
			reset
	</button>
	...
	<Link className="d-inline-block w-100" id="ii6s5" target="_self" to="/login" type="spa"
	>
